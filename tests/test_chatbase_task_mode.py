...
from . import FakeChatbaseServer, BULK_RESPONSE_DICT, CLICK_RESPONSE_DICT, EVENT_RESPONSE_DICT
...
def cb(event_loop: asyncio.AbstractEventLoop):
    _chatbase = Chatbase(CHATBASE_TOKEN, CHATBOT_PLATFORM, loop=event_loop, task_mode=True)
    yield _chatbase
